...
export class HealthDataService {
  ...
  fetchData(limit = 10000) {
    const URL = "https://health.data.ny.gov/resource/gnzp-ekau.json?$where=UPPER(ccs_diagnosis_description) like '%25CANCER%25'&$limit=" + limit;
    const headers = new HttpHeaders({
      'X-App-Token': 's531pn4GysUoyqwya79K1cAlz'
    })
